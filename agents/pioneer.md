...
1. **Discovery**: Surface emerging trends via web search, arXiv, and documentation research
2. **Hypothesis**: Formulate a specific hypothesis about the technology's applicability
3. **Prototype**: Build a minimal proof-of-concept to validate the hypothesis
4. **Synthesize**: Document findings with code examples, trade-offs, and adoption recommendations
5. **Handoff**: Publish actionable insights to shared context for builders to implement
</workflow>
